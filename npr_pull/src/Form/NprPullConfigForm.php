...
class NprPullConfigForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['topic_vocabularies'] = [
      ...
      '#description' => $this->t('Each vocabulary selected MUST have a string field with the machine name `field_npr_news_id`, a boolean field with the machine name `field_npr_subscribe`, and use the `name` field for the title.'),
